...
if(!isset($_SESSION["pelanggan"])){
	echo "<script>alert('Anda Belum Login, Silahkan Login terlebih dahulu sebelum transaksi');</script>";
	...
	<div class="container">
		...
		<form method="post">
			...
			<div class="row">
				<div class="col-md-4">
					<div class="form-group">
						<input type="text" readonly value="<?php echo $_SESSION["pelanggan"]['nama_pelanggan'] ?>" clas="form-control">
					</div>
				</div>
				<div class="col-md-4"><div class="form-group">
				<input type="text" readonly value="<?php echo $_SESSION["pelanggan"]['telepon_pelanggan'] ?>" clas="form-control">
			</div></div>
				<div class="col-md-4">
					<select class="form-control" name="id_ongkir">
						...
						while ($perorngkir=$ambil->fetch_assoc()) {
						?>
						<option value="<?php echo $perorngkir["id_ongkir"] ?>">
							<?php echo $perorngkir['nama_kota'] ?>
							Rp. <?php echo number_format($perorngkir['tarif']) ?>
						</option>
						<?php } ?>
					</select>
				</div>
			...
			<div class="form-group">
				...
				<textarea class="form-control" name="alamat_pengiriman" placeholder="masukan alamat pengiriman"></textarea>
			</div>
		...
		if (isset($_POST["checkout"]))
		{
			...
			{
				//mendapatkn data produk berdasarkan id_produk
				$ambil=$koneksi->query("SELECT * FROM produk WHERE id_produk='$id_produk'");
